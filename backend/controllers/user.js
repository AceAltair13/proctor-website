...
const registerStudent = async (req, res) => {
    try {
        ...
        let student = new Student(req.body.firstName,req.body.lastName,req.body.phoneNumber,req.body.emailId,req.body.userName,req.body.password)
...
const registerSupervisor = async (req, res) => {
    try {
        ...
        let supervisor = new Supervisor(req.body.firstName,req.body.lastName,req.body.phoneNumber,req.body.emailId,req.body.userName,req.body.password)
        const hashedPassword = CryptoJs.AES.encrypt(req.body.password, config.passKey).toString();
        // const data = { ...req.body, password: hashedPassword, isSupervisor: false ,isStudent:true, isAdmin:false }
