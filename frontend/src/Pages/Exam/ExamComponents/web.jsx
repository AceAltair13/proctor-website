...
function App() {
    ...
    const userImageLink = "https://firebasestorage.googleapis.com/v0/b/examinator-2c5f7.appspot.com/o/jetha1.jpg?alt=media&token=a68d1461-9342-4ff2-83d0-574907848437";
    ...
    const loadImage = () => {
        ...
        return Promise.all(
            labels.map(async (label) => {
                ...
                var link = "http://127.0.0.1:8081/" + userImageLink
